...
const Poglavje = ({ children, naslov, level = 0 }: PoglavjeProps) => {
    ...
    switch (level) {
        case 0: spremenjen_naslov = <Typography variant="h3">{naslov}</Typography>; break
        case 1: spremenjen_naslov = <Typography variant="h4">{naslov}</Typography>; break
        case 2: spremenjen_naslov = <Typography variant="h5">{naslov}</Typography>; break
        default: spremenjen_naslov = <Typography variant="h6">{naslov}</Typography>; break
    }
